 ...
 */
#App\Plugins\Other\LoginSocialite\AppConfig.php
namespace App\Plugins\Other\LoginSocialite;

use App\Plugins\Other\LoginSocialite\Models\PluginModel;
...
class AppConfig extends ConfigDefault
{
    public function __construct()
    {
        ...
        $this->scartVersion = $config['configKey'];
        //Path
